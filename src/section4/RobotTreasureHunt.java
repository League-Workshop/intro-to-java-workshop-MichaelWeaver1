...
public class RobotTreasureHunt implements KeyEventDispatcher{
	...
	private void spaceBarWasPressed() {
		...
		int robotXLocation = marvin.getX();
		int robotYLocation = marvin.getY();
		
		// 6. Print the robotXLocation and robotYLocation variables to the console s
